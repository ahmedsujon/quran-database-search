...
class MAinMenuSeeder extends Seeder
{
    ...
    {
        $menuItems = [
            ['id' => 1, 'menu_name' => "Topics on Allah, i.e., Allah’s Will, Face of Allah, Mercy of Allah, Allah’s Forgiveness, Allah’s Greatest Names, Allah's Light, etc."],

            ['id' => 2, 'menu_name' => "Other Topics Directly Related to Allah, Including Allah's Actions Against Disbelievers, Friends of Allah, Whom Allah's Loves, Not Love, His Curse, Who He Guides, Does not Guide, Etc"],
            ...
            ['id' => 7, 'menu_name' => "Activities in Our Daily Life: Making Intention, Saying Bismillah and Inshallah, Greetings, How to Receive Allah's Mercy and Forgiveness, Interest, Repentance, Hijab, Anger Control, How to be Successful, Eating Food of the People of the Book, Envy, Good Spending Behaviour, Social Behaviour, Riya, Kindness, Begging, Visiting Grave, Drinking, Creation of Will"],

            ['id' => 8, 'menu_name' => "General Topics on Accountability, Friendship, Reminder of genorosity, Idle Talk, Intercession, Ruqya, Jihad, Zikr, Nightly Worship, Halal and Forbidden Food, Parenting, Revenge, Muslim Brotherhood, Obeying People in Authority, Trials in Islam, Losers or Unsuccessful, Expiation for doing Wrong, Lawful Earning, Exercising Patience"],

            ['id' => 9, 'menu_name' => "Social Evils Like Slander, Spreading Rumor, Spying, Adultery. Arrogance, Back Biting, Being Ungrateful, Bribery, Greed, Guarding Tongue, Homosexuals, Liar, Thief, Treachery, Prostitution"],

            ['id' => 10, 'menu_name' => "Special Topics on Current Condition of the Muslims, Transitory Nature of the World, Deception, How to save yourself from Satan, Allah's Checks and Balances to Control Mankind, Kowledge of the Unseen, Status of Chosen Few, Revert, Intention of the Disbelievers Towards Muslim, Dead Benefitting from the Living, Book of Record, Regrets, Martyrs, Etc."],
            ...
            ['id' => 16, 'menu_name' => "Religious Information or Knowledge: Holy Spirit, Testing Mankind, Blowing of Trumpet, Maintaining Mosque, Whom Allah Punishes, Fortune Teller, Joining Disbeliever's Army, Sustenance and Rizk"],
