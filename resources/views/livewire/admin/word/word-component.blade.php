            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Word or Topic Data</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Word or Topic Data</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    ...
                                    <tbody>
                                        @if ($word_datas->count() > 0)
                                            @php
                                                $sl =
                                                    $word_datas->perPage() * $word_datas->currentPage() -
                                                    ($word_datas->perPage() - 1);
                                            @endphp
                        ...
                        <div class="card-footer bg-transparent">
                            {{ $word_datas->links('livewire.admin-pagination') }}
                        </div>
                    </div>
                </div>
            </div>
