            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Contents Data</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Contents Data</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    <thead>
                                        <tr>
                                            <th class="align-middle">Word Or Topic</th>
                                            <th class="align-middle">Search Value</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @if ($content_datas->count() > 0)
                                            @php
                                                $sl =
                                                    $content_datas->perPage() * $content_datas->currentPage() -
                                                    ($content_datas->perPage() - 1);
                                            @endphp
                        ...
                        <div class="card-footer bg-transparent">
                            {{ $content_datas->links('livewire.admin-pagination') }}
                        </div>
                    </div>
                </div>
            </div>
