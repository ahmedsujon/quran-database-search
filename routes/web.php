...
use App\Livewire\App\ArabicQueriesSearch\ArabicQuerySearchComponent;
use App\Livewire\App\ArabicQueriesSearch\ArabicQuerySearchResultComponent;
...
// Arabic Query Search
// Route::get('/arabic-query-search-menus', ArabicQuerySearchComponent::class)->name('app.ArabicQuerySearchMenu');
Route::get('/arabic-query-search/{id}', ArabicQuerySearchComponent::class)->name('app.ArabicQuerySearch');
Route::get('/arabic-query-search-result', ArabicQuerySearchResultComponent::class)->name('app.ArabicQuerySearchResult');
